...
class CreateMovimientosDetalleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('movimientos_detalle', function (Blueprint $table) {
            ...
            $table->unsignedInteger('movimiento_maestro_id')->nullable();
            $table->foreign('movimiento_maestro_id')->references('id')->on('movimientos_maestro')->onDelete('cascade');
