var users_table = $('#users-table').DataTable({
          ...
          
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            if(rol_user == 'Super-Administrador' && data == 'Activo' && full.empresa == null && full.perfil == null || rol_user == 'Administrador' && data == 'Activo' && full.empresa == null && full.perfil == null){
                ...
                "</a>" + "</div>" +
                "<div class='float-center col-lg-3'>" + 
                "<a href='"+urlActual+"/creaperfil/"+full.id+"' class='crea-perfil' >" + 
                "<i class='fas fa-user-cog' title='Asigna Perfil y Empresa'></i>" + 
                "</a>" + "</div>" + 
                "<div class='float-center col-lg-3'>" + 
            ...
            else if(rol_user == 'Super-Administrador' && data == 'Activo' && full.empresa !== null && full.perfil !== null || rol_user == 'Administrador' && data == 'Activo' && full.empresa !== null && full.perfil !== null){
                return "<div id='" + full.id + "' class='text-center'>" + 
