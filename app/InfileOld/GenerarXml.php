...
class GenerarXml {
	public function ToXML($transaccion)
	{
		...
		if (get_class($transaccion)=="App\Infile\DocumentoFel")
		{
            ...
            if ($Personeria != NULL)
             ...
             if ($Exportacion != NULL) {
                    ...
                    //p_log("De exportacion"); // TODO by bersof
             }
           ...
           if ($cantidad_frases == 0) {
            ...
            $cantidad_detalles = count($documento_fel->getItems());
           	...
           	if ($cantidad_detalles == 0) {
                ...
                //REM BY BERSOF $cantidad_adendas = count($documento_fel->getAdenda());
                $cantidad_adendas = 1;
		...
		if (get_class($transaccion)=="App\Infile\AnulacionFel")
		{
	...
	public function imprime_complementos($complemento, $posicion) {
        ...
        switch ($tipo_complemento) {
            case "ComplementoExportacion":
                ...
                break;
            case "App\Infile\ComplementoCambiaria":
            ...
            case "ComplementoFacturaEspecial":
                ...
                $retencion_iva = $especial->getRetencionIVA();
                ...
                $plantilla_especial = "<dte:Complemento IDComplemento=\"" . $id_complemento . "\" NombreComplemento=\"" . $nombre_complemento . "\" URIComplemento=\"" . $uri . "\">\n"
                        ...
                        . " <cfe:RetencionIVA>" . $retencion_iva . "</cfe:RetencionIVA>\n"
                ...
                break;
            case "App\Infile\ComplementoNotas":
