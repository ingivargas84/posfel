...
class NotaCreditoel{
    ...
    public function generarFEL($idAbonoMaestro, $idCliente){
	    ...
	    $datos_emisor->setCodigoEstablecimiento(2);
        ...
        $datos_receptor->setCorreoReceptor("micorreo@infile.com.gt");
     ...
     $complemento_notas->setMotivoAjuste("PRUEBA DE NOTA DE CREDITO");
    ...
    //   dd($documento_fel);
      ...
      $conexion->setUsuario("INFILEDEMOINTERNO");
      $conexion->setLlave("DF49C2CC2B9D9306896B71EB4B5A74D8");
    ...
    public function anularFEL($idAbonoMaestro, $idCliente){
        ...
        $anulacion_fel->setMotivoAnulacion("ANULACION DE PRUEBA");
