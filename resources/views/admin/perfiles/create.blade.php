...
@section('content')
    <form method="POST" id="PerfilForm"  action="{{route('perfiles.save')}}">
            {{csrf_field()}}
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" placeholder="Perfil" name="descripcion" >
                            </div>
                        </div>
                        <br>
                        <div class="text-right m-t-15">
                            <a class='btn btn-primary form-button' href="{{ route('perfiles.index') }}">Regresar</a>
                            <button id="ButtonPerfil" class="btn btn-success form-button">Guardar</button>
                        </div>
...
<script src="{{asset('js/perfiles/create.js')}}"></script>
@endpush
