       ...
       <div class="row">
        ...
        <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
                <tr>
                    ...
                    <td style="font-size:14px; text-align:right;" width="30%"> <strong>FACTURA CAMBIARIA ELECTRÓNICA</strong> </td>
                </tr>
                <tr>
                    <td style="font-size:12px; text-align:center;" width="40%"> 10a. AVENIDA 21-13, ZONA 1</td>
                    <td style="font-size:14px; text-align:right;" width="30%"> LIBRE DE PROTESTO </td>
                </tr>
                <tr>
                    <td style="font-size:12px; text-align:center;" width="40%"> PBX: 2427-9999 </td>
                    <td style="font-size:12px; text-align:right;" width="30%"> Serie: {{{ $facturamaestro[0]->fel_serie }}} </td>
                </tr>
                <tr>
                    <td style="font-size:12px; text-align:center;" width="40%"> GUATEMALA, GUATEMALA </td>
                    <td style="font-size:12px; text-align:right;" width="30%"> Número: {{{ $facturamaestro[0]->fel_numero }}} </td>
                </tr>
                <tr>
                    <td style="font-size:12px; text-align:center;" width="40%"> <strong> NIT: 842754-2 </strong> </td>
                    <td style="font-size:12px; text-align:right;" width="30%"> Orden de Compra: {{{ $facturamaestro[0]->orden_compra }}} </td>
                </tr>
            </table>
            <br>
            <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
                <tr>
                    <td style="font-size:14px; text-align:left;" width="80%"> <strong>Autorización: </strong>  {{{ $facturamaestro[0]->fel_uuid }}} </td>
                    <td style="font-size:14px; text-align:left;" width="20%"> <strong>Fecha: </strong> {{Carbon\Carbon::parse($facturamaestro[0]->fel_fecha_certificacion)->format('d-m-Y')}} </td>
                </tr>
            </table>
            <hr>
            <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
...
<div class="footer">
    <table cellspacing=0 cellpadding=0 width= 800 class="table table-striped table-bordered">
            <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:13px; text-align:right;" width="20%">  <u></u> </td>
                </tr>
    </table>
    <hr>
    <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
        <tr>
            <td style="font-size:13px; text-align:left;" width="60%"> <strong>Observaciones: </strong></td>
            <td style="font-size:8px; text-align:justify;" width="40%"> A:</td>
        </tr>
        <tr>
            <td style="font-size:13px; text-align:left;" width="60%"> <strong> </strong></td>
            <td style="font-size:8px; text-align:justify;" width="40%"> SE SERVIRAN USTEDES PAGAR ESTA UNICA FACTURA CAMBIARIA LIBRE DE PROTESTO A LA ORDEN O ENDOSO DE <strong>SUPLIDORA INDUSTRIAL, S.A.</strong> EL VALOR TOTAL POR EL QUE ESTA EXTENDIDA O POR EL ULTIMO SALDO INSOLUTO QUE APAREZCA, VALOR QUE ASENTARAN USTEDES A CUENTA SEGUN NUESTRO AVISO.</td>
        </tr>
    </table>
    <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
        <tr>
            ...
            <td style="font-size:10px; text-align:center;" width="30%"> <strong>SUJETO A PAGOS TRIMESTRALES</strong></td>
    ...
    <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
        <tr>
            <td style="font-size:8px; text-align:justify;" width="100%"> 1. EL COMPRADOR DA COMO BUENO EL VALOR TOTAL QUE SE INDICA EN ESTA FACTURA CAMBIARIA Y SE COMPROMETE A CANCELARLO EN LA FECHA DE VENCIMIENTO ESTIPULADO.</td>
        </tr>
        <tr>
            <td style="font-size:8px; text-align:justify;" width="100%"> 2. LA FIRMA DE CUALQUIER EMPLEADO DEPENDIENTE DEL COMPRADOR AL ACEPTAR ESTA FACTURA, OBLIGARA A ESTE CUMPLIR CON TODAS LAS CONDICIONES ESTIPULADAS EN LA MISMA, LO MISMO LA NOTA DE PEDIDO, CONTRATO, ORDEN DE COMPRA, ETC.</td>
        </tr>
        <tr>
            <td style="font-size:8px; text-align:justify;" width="100%"> 3. SI EL COMPRADOR INCURRIERE EN ATRASO EN EL PAGO DE ESTA FACTURA, ACEPTA UN CARGO DEL 2% MENSUAL.<td>
        </tr>
        <tr>
            <td style="font-size:8px; text-align:justify;" width="100%"> 4. EN VENTAS AL CREDITO ESTA FACTURA NO SE CONSIDERA CANCELADA SIN SU RESPECTIVO RECIBO DE CAJA, SI SU COMPRA ES AL CONTADO EL SELLO DE CANCELADO ES SU COMPROBANTE DE PAGO.<td>
        </tr>
    ...
    <table cellspacing=0 cellpadding=2 width= 800 class="table table-striped table-bordered">
        <tr>
            <td style="font-size:10px; text-align:center; border-style: solid none none none;" width="25%"> <strong>FIRMA Y SELLO DE SUPLIDORA INDUSTRIAL S.A.</strong> </td>
            <td style="font-size:10px; text-align:center;" width="12%"> </td>
            <td style="font-size:10px; text-align:center; border-style: solid none none none;" width="25%"> <strong>FIRMA Y SELLO DEL COMPRADOR</strong> </td>
            <td style="font-size:10px; text-align:center;" width="12%"> </td>
            <td style="font-size:10px; text-align:center; border-style: solid none none none;" width="25%"> <strong>FECHA DE ACEPTACIÓN</strong></td>
        </tr>    
        <tr>
        ...
        <tr>
            <td style="font-size:12px; text-align:right;" colspan="5" width="100%"> <img width="50px" src="images/fel.png"> </td>
