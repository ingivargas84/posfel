...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #369ff3;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"><h3><strong>Suplidora Industrial S.A.</strong></h3><span class="sr-only">(current)</span></a>
      </li>
    </ul>
  ...
  <div class="col-md-3 col-sm-12 col-xs-12 pl-5 pr-5 mt-5 pt-5 text-center centra_vertical">
    <img class="img-fluid" src="/images/logo.jpeg" width="400px">
  </div>
  <div class="col-md-9 col-sm-12 col-xs-12 mt-5 pt-5 text-right centra_vertical">
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img class="d-block img-fluid" width="900px" src="{{url('images/imagen3.png')}}" alt="Third slide">
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-md-10 mx-auto">
              ...
              <center><p class="copyright text-muted"><strong>Copyright &copy; 2021 · Suplidora Industrial. All rights reserved</strong> </p></center>
            </div>
          </div>
        </div>
      </footer>      
